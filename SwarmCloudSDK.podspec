...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/cdnbye/SwarmCloudSDK"
  ...
  spec.source       = { :git => "https://github.com/cdnbye/SwarmCloudSDK.git", :tag => "#{spec.version}" }
  ...
  spec.dependency 'CocoaLumberjack', '~> 3.7'
